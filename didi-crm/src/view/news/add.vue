<template>
    <div id="newsAdd">
        <el-form ref="form" :model="formData" label-width="80px">
            ...
            <el-form-item>
                <el-button type="primary" class="btn" v-if="$route.name=='新闻添加页'" @click="postData">提交</el-button>
            </el-form-item>
            <el-form-item>
                <el-button type="danger" class="btn" v-if="$route.name=='新闻编辑页'" @click="saveAndPost">保存并提交</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
